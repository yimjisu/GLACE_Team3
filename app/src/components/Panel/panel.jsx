...
const Panel = ({ state, setState }) => {
  ...
  useEffect(async () => {
    ...
    if (
      state == State.SelectShow ||
      state == State.SelectSeat ||
    ...
    <div className={styles.panel}>
      {state == State.SelectShow && (
        <SelectShow
          ...
          setSelectedShowInfo={setSelectedShowInfo}
        />
      )}
      {state == State.SelectSeat && (
        <SelectSeat
      ...
      {state == State.UserInfo && (
        <UserInfo
          setState={setState}
          setUserReservationInfo={setUserReservationInfo}
        />
      )}
      {state == State.ReservationInfo && (
        <ReservationInfo
          setState={setState}
          userReservationInfo={userReservationInfo}
        />
      )}
    </div>
  );
