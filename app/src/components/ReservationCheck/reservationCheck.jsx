    ...
    <div>
      <div className={styles.flex}>
        <div className={styles.card}>
          <Card>
            <Card.Header>
              <div className={styles.header}>{selectedShowInfo.title}</div>
            </Card.Header>
            <Card.Img variant="top" height="500px" src={selectedShowInfo.img} />
            <Card.Footer>
              <div className={styles.footer}>
                장소: {selectedShowInfo.place}
                <br />
                날짜: {ymd}
                <br />
                시간:{selectedShowInfo.time.time}
                <br />
        ...
        <div className={styles.login}>
          <form className={styles.userInfo}>
            <div className={styles.title}>비회원 로그인</div>
            <br />
            ...
            <table>
              <tr>
                ...
                <td align="left">
                  <input
                    ...
                    type="text"
                    size="26"
                    placeholder="번호만 입력(ex.01012345678)"
                    onKeyUp={phoneCheck}
                  />
                  &nbsp;&nbsp;&nbsp;
                  <span className={styles.explain} id="phoneCheck"></span>
                </td>
              </tr>
              <tr height="7">
                <td colspan="3">
              ...
              <tr>
                ...
                <td align="left">
                  ...
                  />
                  &nbsp;&nbsp;&nbsp;
                  <span className={styles.explain} id="pwCheck"></span>
                </td>
              </tr>
              <tr height="7">
                <td colspan="3">
              ...
              <tr>
                ...
                <td align="left">
                  ...
                  />
                  &nbsp;&nbsp;&nbsp;
                  <span className={styles.explain} id="pwSame"></span>
                </td>
              </tr>
            </table>
          </form>
